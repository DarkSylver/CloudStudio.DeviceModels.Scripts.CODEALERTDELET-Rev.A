...
# Configuration Script – CODE ALERT DELET - Rev. A

This **Configuration** script is designed for the **CODE ALERT DELET** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CODE ALERT DELET Rev. A

Este script de **Configuration** está diseñado para el modelo **CODE ALERT DELET** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
